...
export function PageIndexDropdown(props: Props) {
  ...
  const trigger = (
    <Button variant="outline" size="sm" className="gap-2 font-sans" aria-label="Open contents">
    ...
    return (
      <Drawer open={open} onOpenChange={setOpen}>
        ...
        <DrawerContent className="px-2 pb-4">
          <DrawerTitle className="px-3 pt-2 font-display text-base">Contents</DrawerTitle>
